<svelte:options
	customElement={{
		tag: 'test-el',
		props: {
			textColor: { attribute: 'text-color', type: 'String' },
...
<script>
	import Icon from '$lib/assets/icons.svg';
	let { textColor = '#fff', backgroundColor = '#4b4b4b' } = $props();
</script>

<footer class="footer" style={`--footer-bg: ${backgroundColor}; --footer-text: ${textColor};`}>
	<div class="footer__logo">
		<a href="https://www.csis.org" title="CSIS website" target="_blank" class=""
			><svg
				width="280"
				height="39"
				viewBox="0 0 253 36"
	...
	<div class="footer__desc">
		<p class="">
			Established in Washington, D.C., nearly 60 years ago, the Center for Strategic and
			International Studies (CSIS) is a bipartisan, nonprofit policy research organization dedicated
			to advancing practical ideas that address the world’s greatest challenges.
		</p>
	</div>
		...
		<ul class="social">
			<li class="social__item">
				<a
					...
					><svg class="icon__social" focusable="false"><use href="{Icon}#Icon-facebook"></use></svg
					><!----></a
				>
			</li>
			<li class="social__item">
				<a
					class="social__link"
					target="_blank"
					href="https://x.com/csis"
					aria-label="Visit the CSIS Twitter page"
					><svg class="icon__social" focusable="false"><use href="{Icon}#Icon-twitter"></use></svg
					><!----></a
				>
			</li>
			<li class="social__item">
				<a
					...
					><svg class="icon__social" focusable="false"><use href="{Icon}#Icon-linkedin"></use></svg
					><!----></a
				>
			</li>
			<li class="social__item">
				<a
					...
					><svg class="icon__social" focusable="false"><use href="{Icon}#Icon-instagram"></use></svg
					><!----></a
				>
			</li>
			<li class="social__item">
				<a
					...
					><svg class="icon__social" focusable="false"><use href="{Icon}#Icon-youtube"></use></svg
					><!----></a
				>
			</li>
			<li class="social__item">
				<a
					class="social__link"
					target="_blank"
					href="SChavez@csis.org"
					aria-label="Visit the CSIS Email page"
					><svg class="icon__social" focusable="false"><use href="{Icon}#Icon-email"></use></svg
					><!----></a
				>
			</li>
		</ul>
	...
	<p class="footer__copyright">
		© 2025 Center for Strategic and International Studies. All rights reserved. | <a
			href="https://www.csis.org/privacy-policy"
			target="_blank"
			class="footer__privacy-pol">Privacy Policy</a
		>
	</p>
</footer>

<style>
	@import url('https://use.typekit.net/tfb5hou.css');
	...
	.share__link {
		...
		filter: invert(100%) sepia(0%) saturate(7493%) hue-rotate(330deg) brightness(108%)
			contrast(104%);
	}
	.share__link:hover {
		filter: invert(63%) sepia(37%) saturate(177%) hue-rotate(156deg) brightness(88%) contrast(84%);
	}
	.share__link:focus {
	...
	.footer {
		...
		background-color: #02364e;
		border-top: 1px solid rgb(188, 194, 206);
		display: grid;
